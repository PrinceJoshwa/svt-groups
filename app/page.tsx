...
// // //     body: "A state-of-the-art clubhouse featuring steam and sauna rooms to unwind and socialize.",
// // //   },
// // //   {
// // //     icon: Waves,
// // //     title: "Swimming Pool",
// // //     body: "A pristine recreational swimming pool designed for daily relaxation and fitness.",
// // //   },
// // //   {
// // //     icon: Dumbbell,
// // //     title: "Fitness Center",
// // //     body: "Fully equipped modern gymnasium and outdoor jogging and cycling tracks.",
// // //   },
// // //   {
// // //     icon: Trophy,
// // //     title: "Sports & Recreation",
// // //     body: "Badminton courts, basketball courts, and dedicated safe children's play areas.",
// // //   }
// // // ];
...
// // //             >
// // //               <span className="h-px w-8 bg-gold/60" />
// // //               Project in Confident Atria • Built by SVT Developers
// // //             </p>
// // //             <h1
// // //               className={`font-[family-name:var(--font-display)] italic font-light text-[clamp(2.5rem,5vw,4.5rem)] leading-[1.1] text-pearl transition-all duration-700 delay-100 ${heroIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
// // //             >
...
// // //               className={`mt-8 max-w-lg text-[16px] font-light leading-relaxed text-pearl/70 transition-all duration-700 delay-200 ${heroIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}
// // //             >
// // //               A limited collection of East-facing 4 BHK villas rising through three considered levels — arrival, private, and sky. Exclusively marketed by RRL Group. Starting Price 2 Cr*.
// // //             </p>

// // //             <Reveal delay={250} className={`mt-6 transition-all duration-700 ${heroIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
// // //               <div className="inline-flex items-center gap-3 rounded-full border border-gold/40 bg-gold/10 px-5 py-2.5 text-[12px] font-bold tracking-[0.15em] uppercase text-gold backdrop-blur-md shadow-[0_0_15px_rgba(212,175,55,0.15)]">
// // //                 <Key className="h-4 w-4" /> Get Possession in 4 Months
// // //               </div>
// // //             </Reveal>
...
// // //             <div className="rounded-3xl overflow-hidden border border-navy/10 shadow-lg bg-[#F8F9FA] aspect-[4/3] relative group cursor-pointer">
// // //               <Image 
// // //                 src="https://ik.imagekit.io/j0xzq9pns/svt/Screenshot%202026-07-18%20142144.png"
// // //                 alt="First Floor Plan"
// // //                 fill
// // //                 className="object-cover transition-all duration-700 ease-out group-hover:scale-105 blur-[3px] group-hover:blur-0"
// // //               />
...
// // //             <div className="rounded-3xl overflow-hidden border border-navy/10 shadow-lg bg-[#F8F9FA] aspect-[4/3] relative group cursor-pointer">
// // //               <Image 
// // //                 src="https://ik.imagekit.io/j0xzq9pns/svt/Screenshot%202026-07-18%20142207.png"
// // //                 alt="Full Floor Plans"
// // //                 fill
// // //                 className="object-cover transition-all duration-700 ease-out group-hover:scale-105 blur-[3px] group-hover:blur-0"
// // //               />
...
// // //                     Built by SVT Developers | Marketed by RRL Group<br />
// // //                     {ADDRESS[0]}<br />
// // //                     {ADDRESS[1]}<br />
// // //                     {ADDRESS[2]}
// // //                   </p>
...
// // //               <div className="pt-10 border-t border-white/10">
// // //                  <p className="text-[14px] text-pearl/60 font-light leading-relaxed">
// // //                    <strong className="text-pearl font-medium">Built by SVT Developers | Marketed by RRL Group</strong> <br />
// // //                    {ADDRESS.join(", ")}
// // //                  </p>
// // //               </div>
// // //             </div>
...
// // //             </span>
// // //           </div>
// // //           <p className="text-[13px] text-navy/40 font-medium tracking-wide">© {new Date().getFullYear()} Built by SVT Developers | Marketed by RRL Group</p>
// // //         </div>
// // //       </footer>
// // //     </main>
// // //   );
...
// //       {/* ---------------------------------------------------------- AMENITIES (UPDATED TO MATCH MAGICBRICKS) */}
// //       <section className="relative px-6 lg:px-10 py-32 bg-[#F8F9FA] border-y border-navy/5">
// //         <div className="mx-auto max-w-7xl">
// //           <Reveal className="text-center max-w-2xl mx-auto mb-20">
// //             <p className="text-[12px] tracking-[0.2em] uppercase text-gold mb-4">Living Here</p>
