...
// // /*  Assets                                                            */
// // /* ------------------------------------------------------------------ */
// // const HERO_IMAGE = "https://ik.imagekit.io/j0xzq9pns/svt/Atria%20poster%20web.png";
// // const RRL_LOGO = "https://ik.imagekit.io/j0xzq9pns/svt/logo.png";
// // const BROCHURE_URL = "https://ik.imagekit.io/j0xzq9pns/svt/STRRPA-Approved-4-BHK-Residential-Villas-in-Confident-Atria-Gated-Community%20(8).pdf";
...
// // const ADDRESS = [
// //   "Confident Atria",
// //   "Billapura, Sarjapura - Attibele Road",
// //   "Bengaluru, Karnataka",
// // ];
...
// // const AMENITIES = [
// //   { icon: Coffee, title: "Premium Clubhouse", body: "A Family & Social hub featuring a premium clubhouse, banquet hall, and an outdoor amphitheater." },
...
// //   { icon: Trophy, title: "Sports & Courts", body: "Tennis & basketball courts, dedicated indoor squash and badminton courts, and an indoor games room." },
...
// //   { icon: TreePine, title: "Parks & Open Lawns", body: "Beautiful flower gardens, landscaped open lawns, and a dedicated safe children's play area." },
// //   { icon: ShieldCheck, title: "24/7 Manned Security", body: "Fully gated community with 24/7 manned security, extensive CCTV surveillance, and visitor parking." },
// //   { icon: Droplets, title: "Eco-Friendly Infrastructure", body: "Concrete internal roads, eco-friendly rainwater harvesting, and robust water storage systems." },
// //   { icon: Sun, title: "Vaastu Compliant", body: "Thoughtfully designed spaces ensuring 100% Vaastu compliance along with a dedicated meditation area." },
// // ];
...
// //   places: string[];
// // }[] = [
// //   { category: "Education", icon: GraduationCap, places: ["Azim Premji University", "TISB School", "Indus School", "Global Indian International School"] },
...
// //       const unlockedState = localStorage.getItem("atria_unlocked");
...
// //         setIsUnlocked(true);
// //         if (typeof window !== "undefined") {
// //           localStorage.setItem("atria_unlocked", "true");
// //         }
...
// //   return (
// //     <main
// //       className={`${display.variable} ${body.variable} ${mono.variable} bg-[#FAFAFA] text-navy font-[family-name:var(--font-body)] selection:bg-gold selection:text-navy scroll-smooth overflow-x-hidden relative`}
// //     >
// //       <style jsx global>{`
// //         @keyframes floatSlow {
// //           0%, 100% { transform: translateY(0) translateX(0); }
...
// //           target="_blank" 
// //           rel="noopener noreferrer" 
// //           className="group flex items-center justify-center gap-2 rounded-full bg-navy/95 backdrop-blur-md px-5 py-3.5 text-[12px] font-bold tracking-wider text-pearl uppercase border border-gold/40 shadow-[0_4px_20px_rgba(0,0,0,0.25)] hover:bg-gold hover:text-navy transition-all duration-300"
// //         >
// //           <Download className="h-4 w-4" /> 
// //           <span className="hidden sm:inline-block overflow-hidden max-w-0 group-hover:max-w-xs transition-all duration-500 ease-in-out whitespace-nowrap">
// //             Download Brochure
// //           </span>
...
// //           target="_blank" 
// //           rel="noopener noreferrer" 
// //           className="flex items-center justify-center h-14 w-14 rounded-full bg-[#25D366] text-white shadow-[0_4px_20px_rgba(37,211,102,0.4)] hover:scale-110 transition-transform duration-300"
// //         >
...
// //             <a
// //               href="#enquire"
// //               className={`inline-flex items-center gap-2 rounded-full px-6 py-2.5 text-[13px] font-bold tracking-wide transition-all duration-300 ${
// //                 scrolled 
// //                   ? "bg-gold text-navy hover:bg-navy hover:text-pearl" 
// //                   : "bg-gold text-navy hover:bg-pearl hover:text-navy"
// //               }`}
// //             >
// //               Book Site Visit
// //             </a>
// //             <a
// //               href={`tel:+91${PHONES[0]}`}
// //               className={`inline-flex items-center gap-2 rounded-full border px-6 py-2.5 text-[13px] font-medium tracking-wide transition-all duration-300 ${
// //                 scrolled 
// //                   ? "border-navy/20 text-navy hover:bg-navy hover:text-pearl" 
// //                   : "border-pearl/40 text-pearl hover:bg-pearl hover:text-navy"
// //               }`}
...
// //               </a>
// //             ))}
// //             <a href="#enquire" onClick={() => setNavOpen(false)} className="mt-2 text-gold font-bold">BOOK SITE VISIT</a>
// //           </div>
// //         )}
// //       </header>
...
// //       <section className="relative overflow-hidden bg-navy text-pearl pt-28 sm:pt-32 pb-16 px-6 lg:px-10">
// //         <div className="absolute inset-0 -z-10">
// //           <div className="absolute -top-32 right-[-8%] h-[560px] w-[560px] rounded-full bg-gold/[0.12] blur-[120px] animate-float" />
// //           <div className="absolute bottom-[-10%] left-[-8%] h-[420px] w-[420px] rounded-full blur-[100px] animate-float-slow bg-gold/[0.08]" />
// //           <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-[0.1]"></div>
// //           <div className="absolute inset-0 bg-gradient-to-b from-transparent via-navy/50 to-navy opacity-80" />
// //         </div>

// //         <div className="mx-auto max-w-7xl grid lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-20 lg:items-center lg:min-h-[75vh]">
// //           {/* Left Hero Content */}
// //           <div className="pt-6 sm:pt-10 z-10">
// //             <div className={`flex items-center gap-3 mb-6 transition-all duration-700 ${heroIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
// //               <span className="h-px w-8 bg-gold/60" />
// //               <span className="text-[12px] font-bold tracking-[0.2em] uppercase text-gold/90">Confident Atria by RRL Group</span>
// //             </div>
...
// //             <p className={`mt-6 max-w-lg text-[16px] font-light leading-relaxed text-pearl/80 transition-all duration-700 delay-200 ${heroIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
// //               Premium 4 BHK villa living in a sprawling 25-acre gated community. Sarjapura – Attibele Road, Bengaluru. Starts at just ₹2 CR* onwards.
// //             </p>

// //             <Reveal delay={250} className={`mt-8 flex flex-wrap items-center gap-2 sm:gap-3 transition-all duration-700 ${heroIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
// //               <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1.5 sm:px-4 sm:py-2 text-[10px] sm:text-[11px] font-medium tracking-[0.1em] uppercase text-pearl/80 backdrop-blur-md">
// //                 <Building2 className="h-4 w-4 text-pearl/60 shrink-0" /> Constructed by SVT Developers
// //               </div>
// //               <div className="inline-flex items-center gap-2 rounded-full border border-gold/40 bg-gold/15 px-3 py-1.5 sm:px-4 sm:py-2 text-[10px] sm:text-[11px] font-bold tracking-[0.1em] uppercase text-gold backdrop-blur-md shadow-[0_0_20px_rgba(212,175,55,0.2)]">
// //                 <Milestone className="h-4 w-4 shrink-0" /> Marketed by RRL Group
// //               </div>
// //               <div className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/5 px-3 py-1.5 sm:px-4 sm:py-2 text-[10px] sm:text-[11px] font-bold tracking-[0.1em] uppercase text-white backdrop-blur-md">
// //                 <Key className="h-4 w-4 text-gold shrink-0" /> Possession in 4 Months
...
// //               <a
// //                 href="#enquire"
// //                 className="inline-flex items-center justify-center gap-2 rounded-full bg-gold px-8 py-4 text-[13px] font-bold tracking-wide text-navy hover:bg-pearl transition-colors shadow-[0_0_25px_rgba(212,175,55,0.4)]"
// //               >
// //                 Book Your Site Visit Today! <ArrowUpRight className="h-4 w-4" />
// //               </a>
// //               <a
// //                 href="#residences"
// //                 className="inline-flex items-center justify-center gap-2 rounded-full border border-pearl/40 px-8 py-4 text-[13px] tracking-wide text-pearl hover:bg-pearl/10 transition-colors"
// //               >
// //                 View Floor Plans
// //               </a>
// //             </div>
...
// //             <Reveal delay={200} className={`relative w-full aspect-[4/3] rounded-[2.5rem] overflow-hidden shadow-2xl border border-white/20 transition-all duration-1000 ${heroIn ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"}`}>
// //               <Image 
// //                 src={HERO_IMAGE} 
// //                 alt="Confident Atria Premium Villa Exterior" 
// //                 fill 
...
// //                 <div className="inline-flex items-center gap-2 rounded-full bg-navy/60 backdrop-blur-md border border-gold/30 px-5 py-2">
// //                   <span className="text-[11px] font-bold tracking-[0.2em] text-gold uppercase">Only 12 Villas Available</span>
// //                 </div>
// //               </div>
// //             </Reveal>
...
// //             <div className={`grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4 transition-all duration-700 delay-400 ${heroIn ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
// //               {STATS.map(({ label, value, icon: Icon }) => (
// //                 <div key={label} className="bg-white/[0.06] border border-white/10 p-3 sm:p-4 rounded-2xl backdrop-blur-md flex flex-col gap-2 sm:gap-3 hover:bg-white/10 hover:border-gold/30 transition-colors">
// //                   <div className="h-8 w-8 rounded-full bg-gold/15 flex items-center justify-center">
// //                     <Icon className="h-4 w-4 text-gold" strokeWidth={1.5} />
// //                   </div>
// //                   <div>
// //                     <p className="font-[family-name:var(--font-mono)] text-[15px] font-medium text-pearl leading-tight">{value}</p>
// //                     <p className="text-[10px] tracking-[0.05em] uppercase text-pearl/60 mt-0.5">{label}</p>
// //                   </div>
// //                 </div>
// //               ))}
// //             </div>
...
// //       {/* ---------------------------------------------------------- QUICK ENQUIRY (TOP CONTACT FORM) */}
// //       <section id="quick-enquiry" className="relative px-6 lg:px-10 py-16 sm:py-24 bg-white border-b border-navy/5 overflow-hidden">
// //         <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-[600px] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gold/5 via-transparent to-transparent pointer-events-none" />
...
// //           <Reveal delay={100} className="bg-white rounded-[2rem] border border-gold/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-6 sm:p-10 relative overflow-hidden">
// //             <div className="absolute -top-24 -right-24 h-48 w-48 bg-gold/10 rounded-full blur-3xl" />
// //             <form onSubmit={(e) => submitToFormspree(e, "top")} className="grid sm:grid-cols-2 gap-8 relative z-10">
// //               <input type="hidden" name="_subject" value="New enquiry — Confident Atria (Quick Form)" />
...
// //               <div className="sm:col-span-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-4">
// //                 <button
// //                   type="submit"
// //                   disabled={formStatus.top === "loading"}
// //                   suppressHydrationWarning
// //                   className="w-full sm:w-auto flex-1 rounded-full bg-gold px-8 py-4 text-[13px] font-bold tracking-wider uppercase text-navy hover:bg-navy hover:text-pearl transition-all duration-300 disabled:opacity-60 shadow-[0_4px_15px_rgba(212,175,55,0.3)] hover:shadow-lg"
// //                 >
// //                   {formStatus.top === "loading" ? "Submitting..." : "Submit Enquiry"}
// //                 </button>
// //               </div>
...
// //       {/* ---------------------------------------------------------- OVERVIEW (WITH ENTRANCE IMAGE) */}
// //       <section id="overview" className="relative px-6 lg:px-10 py-24 sm:py-32 bg-[#F8F9FA] overflow-hidden">
...
// //               {/* Project Entrance Image */}
// //               <div className="relative aspect-[4/3] w-full rounded-3xl overflow-hidden shadow-2xl border border-gold/20 group">
// //                 <Image 
// //                   src="https://ik.imagekit.io/j0xzq9pns/svt/WhatsApp%20Image%202026-07-18%20at%205.57.47%20PM.jpeg" 
// //                   alt="Confident Atria Entrance" 
// //                   fill 
// //                   className="object-cover group-hover:scale-105 transition-transform duration-700 ease-out"
// //                 />
// //                 <div className="absolute inset-0 bg-gradient-to-t from-navy/80 via-transparent to-transparent opacity-60 group-hover:opacity-100 transition-opacity duration-500" />
// //                 <div className="absolute bottom-6 left-6 right-6 text-white transform translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-500 delay-100">
// //                   <p className="text-sm font-bold tracking-wider uppercase drop-shadow-md text-gold">Confident Atria</p>
// //                   <p className="text-xs text-white/90 font-light mt-1">Project Entrance View</p>
// //                 </div>
// //               </div>
// //             </Reveal>
...
// //       {/* ---------------------------------------------------------- AMENITIES */}
// //       <section className="relative px-6 lg:px-10 py-24 sm:py-32 bg-white border-y border-navy/5 overflow-hidden">
// //         <div className="absolute top-0 right-0 w-1/2 h-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gold/5 via-transparent to-transparent opacity-60 pointer-events-none" />
// //         <div className="mx-auto max-w-7xl relative z-10">
// //           <Reveal className="text-center max-w-2xl mx-auto mb-20">
// //             <p className="text-[12px] tracking-[0.2em] uppercase text-gold mb-4">Living Here</p>
// //             <h2 className="font-[family-name:var(--font-display)] text-3xl sm:text-4xl leading-tight text-navy">
...
// //             {AMENITIES.map((a, i) => (
// //               <Reveal key={a.title} delay={i * 100}>
// //                 <div className="group h-full rounded-2xl bg-white p-6 sm:p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-2xl transition-all duration-500 border border-navy/5 hover:border-gold/30 hover:-translate-y-2 relative overflow-hidden">
// //                   <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
// //                     <a.icon className="h-24 w-24 text-gold transform translate-x-4 -translate-y-4" />
// //                   </div>
// //                   <div className="relative z-10">
// //                     <div className="h-14 w-14 rounded-full flex items-center justify-center mb-6 bg-[#F8F9FA] group-hover:bg-gold transition-colors duration-500 shadow-inner">
// //                       <a.icon className="h-6 w-6 text-navy group-hover:text-white transition-colors duration-500" strokeWidth={1.5} />
// //                     </div>
// //                     <h3 className="text-[17px] font-semibold text-navy mb-3">{a.title}</h3>
// //                     <p className="text-[14px] leading-relaxed text-navy/60">{a.body}</p>
...
// //           <div className="grid sm:grid-cols-3 gap-6 sm:gap-8">
// //             <Reveal delay={100}>
// //               <div className="group h-full rounded-3xl bg-white p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-xl transition-all duration-500 border border-navy/5 hover:border-gold/30 hover:-translate-y-2">
// //                 <div className="h-14 w-14 rounded-full flex items-center justify-center mb-6 bg-[#F8F9FA] group-hover:bg-gold transition-colors duration-500 shadow-inner">
// //                   <HomeIcon className="h-6 w-6 text-navy group-hover:text-white transition-colors duration-500" strokeWidth={1.5} />
// //                 </div>
// //                 <h3 className="text-[17px] font-semibold text-navy mb-3">Premium Finishes</h3>
// //                 <p className="text-[14px] leading-relaxed text-navy/60">Top-grade materials and brand-name fittings across every room, ensuring lasting luxury.</p>
// //               </div>
// //             </Reveal>
// //             <Reveal delay={200}>
// //               <div className="group h-full rounded-3xl bg-white p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-xl transition-all duration-500 border border-navy/5 hover:border-gold/30 hover:-translate-y-2">
...
// //                 </div>
// //                 <h3 className="text-[17px] font-semibold text-navy mb-3">Spacious Interiors</h3>
// //                 <p className="text-[14px] leading-relaxed text-navy/60">Thoughtfully designed layouts that maximise comfort, functionality, and natural light.</p>
// //               </div>
// //             </Reveal>
// //             <Reveal delay={300}>
// //               <div className="group h-full rounded-3xl bg-white p-8 shadow-[0_4px_20px_rgb(0,0,0,0.03)] hover:shadow-xl transition-all duration-500 border border-navy/5 hover:border-gold/30 hover:-translate-y-2">
...
// //                 </div>
// //                 <h3 className="text-[17px] font-semibold text-navy mb-3">Quality Craftsmanship</h3>
// //                 <p className="text-[14px] leading-relaxed text-navy/60">Skilled workmanship visible in every corner, guaranteeing structural integrity and beauty.</p>
// //               </div>
// //             </Reveal>
// //           </div>
// //         </div>
...
// //       {/* ---------------------------------------------------------- RESIDENCES / FLOOR PLANS */}
// //       <section id="residences" className="relative px-6 lg:px-10 py-24 sm:py-32 bg-white border-t border-navy/5">
// //         <div className="mx-auto max-w-7xl">
// //           <Reveal className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
// //             <div>
// //               <p className="text-[12px] tracking-[0.2em] uppercase text-gold mb-4">Residences</p>
// //               <h2 className="font-[family-name:var(--font-display)] text-3xl sm:text-4xl leading-tight text-navy max-w-lg">Six premium villa layouts</h2>
// //             </div>
// //             <p className="max-w-sm text-[15px] leading-relaxed text-navy/60">
// //               Villas 12, 12A, 124, 125, 181 and 266 — each thoughtfully planned across ground,
// //               first and terrace levels. Submit your details to view every floor plan.
...
// //             {FLOOR_PLAN_IMAGES.map((img, idx) => (
// //               <Reveal key={img.src} delay={idx * 80} className="rounded-3xl overflow-hidden border border-gold/10 shadow-[0_8px_30px_rgb(0,0,0,0.06)] bg-[#F8F9FA] aspect-[3/4] relative group">
// //                 <Image
// //                   src={img.src}
// //                   alt={img.label}
// //                   fill
// //                   className={`object-contain bg-white p-4 transition-all duration-700 ease-out ${!isUnlocked ? "blur-xl scale-110" : "group-hover:scale-105"}`}
// //                 />

// //                 {!isUnlocked && (
// //                   <div className="absolute inset-0 bg-white/40 backdrop-blur-[4px] flex flex-col items-center justify-center z-10">
// //                     <div className="h-16 w-16 rounded-full bg-white flex items-center justify-center mb-4 shadow-[0_4px_20px_rgb(0,0,0,0.1)]">
// //                       <Lock className="h-6 w-6 text-navy/70" />
// //                     </div>
// //                     <button
// //                       onClick={() => setIsPopupOpen(true)}
// //                       suppressHydrationWarning
// //                       className="inline-flex items-center gap-2 rounded-full bg-gold px-7 py-3.5 text-[13px] font-bold tracking-wider text-navy hover:bg-navy hover:text-pearl transition-all duration-300 shadow-[0_0_20px_rgba(212,175,55,0.4)] uppercase"
// //                     >
// //                       Unlock to View
// //                     </button>
// //                   </div>
...
// //       {/* ---------------------------------------------------------- BROCHURE VIEWER */}
// //       <section id="brochure" className="relative px-6 lg:px-10 py-24 sm:py-32 bg-[#F8F9FA] overflow-hidden">
...
// //             </h2>
// //             <p className="text-[15px] text-navy/60 max-w-xl mx-auto mb-10">
// //               Complete details on pricing, floor plans, specifications and amenities — viewable and downloadable in one elegant document.
// //             </p>
// //           </Reveal>

// //           <Reveal delay={100} className="relative rounded-3xl overflow-hidden border border-gold/20 shadow-2xl bg-white aspect-[3/4] sm:aspect-[16/9] group">
// //             <iframe
// //               src={`${BROCHURE_URL}#toolbar=0`}
// //               title="Confident Atria Brochure"
// //               className={`w-full h-full transition-all duration-700 ${!isUnlocked ? "blur-xl scale-110 pointer-events-none" : ""}`}
...
// //             {!isUnlocked ? (
// //               <div className="absolute inset-0 bg-white/50 backdrop-blur-[6px] flex flex-col items-center justify-center z-10">
// //                 <div className="h-20 w-20 rounded-full bg-white flex items-center justify-center mb-6 shadow-[0_8px_30px_rgb(0,0,0,0.1)]">
// //                   <Lock className="h-8 w-8 text-navy/70" />
// //                 </div>
// //                 <button
// //                   onClick={() => setIsPopupOpen(true)}
// //                   suppressHydrationWarning
// //                   className="inline-flex items-center gap-3 rounded-full bg-gold px-8 py-4 text-[14px] font-bold tracking-wider text-navy hover:bg-navy hover:text-pearl transition-all duration-300 shadow-[0_4px_25px_rgba(212,175,55,0.5)] uppercase"
// //                 >
// //                   <FileText className="h-5 w-5" /> Unlock Brochure
// //                 </button>
// //               </div>
// //             ) : (
// //               <a
...
// //                 target="_blank"
// //                 rel="noopener noreferrer"
// //                 className="absolute bottom-6 right-6 inline-flex items-center gap-2.5 rounded-full bg-navy px-6 py-3.5 text-[13px] font-bold tracking-wider text-pearl hover:bg-gold hover:text-navy hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 z-10 uppercase"
// //               >
// //                 <Download className="h-4 w-4" /> Download Brochure
// //               </a>
// //             )}
...
// //       {/* ---------------------------------------------------------- SITE-WISE AREA TABLE */}
// //       <section className="relative px-6 lg:px-10 py-20 sm:py-24 bg-white border-y border-navy/5">
// //         <div className="mx-auto max-w-5xl">
// //           <Reveal className="mb-10 text-center">
// //             <p className="text-[12px] tracking-[0.2em] uppercase text-gold mb-4">Available Units</p>
// //             <h2 className="font-[family-name:var(--font-display)] text-3xl sm:text-4xl leading-tight text-navy">
...
// //             </h2>
// //           </Reveal>
// //           <Reveal delay={100} className="overflow-x-auto rounded-3xl border border-navy/10 bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-1 sm:p-2">
// //             <table className="w-full min-w-[420px] text-[14px]">
// //               <thead>
// //                 <tr className="border-b border-gold/20 bg-[#F8F9FA] rounded-t-2xl">
// //                   <th className="text-left px-6 py-5 font-bold text-navy tracking-wide uppercase text-xs">Site No.</th>
// //                   <th className="text-right px-6 py-5 font-bold text-navy tracking-wide uppercase text-xs">Area (Sq.ft)</th>
// //                 </tr>
// //               </thead>
// //               <tbody>
// //                 {SITE_AREAS.map((row, i) => (
// //                   <tr key={row.site} className={`${i % 2 === 0 ? "bg-white" : "bg-[#FAFAFA]"} hover:bg-gold/5 transition-colors`}>
// //                     <td className="px-6 py-4 text-navy/80 border-t border-navy/5 font-medium">{row.site}</td>
// //                     <td className="px-6 py-4 text-right text-navy font-bold border-t border-navy/5">{row.area}</td>
// //                   </tr>
// //                 ))}
// //               </tbody>
// //             </table>
// //           </Reveal>
// //           <p className="mt-6 text-center text-[13px] text-navy/60 font-light">
// //             All villas are 4 BHK · Total Built-Up Area: ~2,400 Sq.ft · Site areas vary by plot
// //           </p>
// //         </div>
// //       </section>
...
// //       {/* ---------------------------------------------------------- SPECIFICATIONS */}
// //       <section id="specifications" className="relative px-6 lg:px-10 py-24 sm:py-32 bg-navy text-pearl overflow-hidden">
// //         <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-[0.03]" />
// //         <div className="absolute -top-40 -left-40 h-[600px] w-[600px] bg-gold/10 rounded-full blur-[120px] pointer-events-none" />
...
// //             {SPECS.map((group, gi) => (
// //               <Reveal key={group.group} delay={gi * 100} className="bg-white/[0.04] backdrop-blur-md rounded-3xl border border-white/10 p-6 sm:p-10 hover:bg-white/[0.06] hover:border-gold/30 transition-all duration-500 shadow-xl">
// //                 <h3 className="font-[family-name:var(--font-display)] italic text-2xl text-gold mb-8">{group.group}</h3>
// //                 <dl className="divide-y divide-white/10">
// //                   {group.rows.map(([k, v]) => (
// //                     <div key={k} className="flex flex-col sm:flex-row sm:justify-between gap-2 sm:gap-6 py-4 text-[15px]">
// //                       <dt className="text-pearl/60 font-light">{k}</dt>
// //                       <dd className="text-left sm:text-right text-pearl font-medium leading-relaxed">{v}</dd>
// //                     </div>
// //                   ))}
// //                 </dl>
// //               </Reveal>
...
// //       {/* ---------------------------------------------------------- LOCATION */}
// //       <section id="location" className="relative px-6 lg:px-10 py-24 sm:py-32 bg-[#F8F9FA] overflow-hidden">
// //         <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-10 lg:gap-20 items-start">
// //           <Reveal>
// //             <p className="text-[12px] tracking-[0.2em] uppercase text-gold mb-4">Prime Location</p>
// //             <h2 className="font-[family-name:var(--font-display)] text-3xl sm:text-4xl leading-tight text-navy mb-6">
...
// //             {/* Address Block */}
// //             <Reveal delay={50} className="mb-12 p-8 rounded-3xl bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-navy/5 inline-block w-full max-w-lg hover:border-gold/30 transition-colors duration-300">
// //               <div className="flex items-start gap-4">
// //                 <MapPin className="h-6 w-6 text-gold shrink-0 mt-1" />
// //                 <div>
// //                   <p className="text-[12px] font-bold tracking-[0.1em] uppercase text-navy/80 mb-3">Site Address</p>
// //                   <p className="text-[15px] leading-relaxed text-navy/70">
// //                     <span className="text-gold font-bold text-lg block mb-1">Confident Atria</span>
// //                     Constructed by SVT Developers | Marketed by <span className="text-gold font-bold">RRL Group</span><br /><br />
// //                     {ADDRESS[1]}<br />
// //                     {ADDRESS[2]}
// //                   </p>
// //                 </div>
...
// //                 <Reveal key={category} delay={i * 100}>
// //                   <div className="flex items-center gap-3 mb-4">
// //                     <div className="h-12 w-12 rounded-full bg-white shadow-sm flex items-center justify-center border border-navy/5">
// //                       <Icon className="h-5 w-5 text-gold" strokeWidth={2} />
// //                     </div>
// //                     <p className="text-[12px] font-bold tracking-[0.1em] uppercase text-navy/80">{category}</p>
// //                   </div>
// //                   <ul className="space-y-3 border-l-[1.5px] border-gold/30 pl-5 ml-6">
// //                     {places.map((p) => (
// //                       <li key={p} className="text-[14px] font-medium text-navy/70 relative before:absolute before:-left-[24px] before:top-2 before:h-1.5 before:w-1.5 before:rounded-full before:bg-gold">{p}</li>
// //                     ))}
// //                   </ul>
// //                 </Reveal>
// //               ))}
...
// //           {/* Interactive Google Map & Link */}
// //           <Reveal delay={200} className="relative h-full min-h-[400px] sm:min-h-[600px] w-full rounded-[2rem] overflow-hidden border border-gold/20 shadow-2xl lg:sticky lg:top-32 group">
// //             {/* Embedded Live Map */}
// //             <iframe
// //               src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31108.681177651084!2d77.73356061327117!3d12.805374665510427!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae6ef338f9038d%3A0xc3fdeea0b15b67bc!2sSarjapura%20-%20Attibele%20Rd%2C%20Karnataka!5e0!3m2!1sen!2sin!4v1714000000000!5m2!1sen!2sin"
// //               width="100%"
...
// //               loading="lazy"
// //               referrerPolicy="no-referrer-when-downgrade"
// //               className="absolute inset-0 grayscale-[20%] opacity-90 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700 ease-in-out"
// //             />
...
// //               target="_blank"
// //               rel="noopener noreferrer"
// //               className="absolute bottom-6 right-6 inline-flex items-center gap-2.5 rounded-full bg-navy px-6 py-4 text-[13px] font-bold tracking-wider uppercase text-pearl hover:bg-gold hover:text-navy hover:-translate-y-1 hover:shadow-[0_10px_25px_rgba(212,175,55,0.4)] transition-all duration-300 z-10"
// //             >
...
// //       {/* ---------------------------------------------------------- ENQUIRE */}
// //       <section id="enquire" className="relative py-24 sm:py-32 bg-navy text-pearl overflow-hidden border-t border-gold/10">
// //         <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_right,_rgba(212,175,55,0.18)_0%,_transparent_60%)]" />
// //         <div className="absolute inset-0 -z-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-[0.03]" />
...
// //                     key={p}
// //                     href={`tel:+91${p}`}
// //                     className="relative inline-flex items-center gap-3 rounded-full border border-gold/30 bg-gold/5 px-8 py-4 text-[15px] font-medium tracking-wide text-pearl hover:bg-gold hover:text-navy hover:border-gold hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(212,175,55,0.3)] transition-all duration-300"
// //                   >
// //                     <Phone className="h-4 w-4 relative" /> <span className="relative font-bold">{p}</span>
// //                   </a>
// //                 ))}
// //               </div>
...
// //             {/* Right Column: Premium Contact Form */}
// //             <div className="bg-white/[0.04] border border-gold/20 rounded-[2.5rem] p-8 sm:p-12 backdrop-blur-xl shadow-2xl relative">
// //               <div className="absolute -top-10 -right-10 h-40 w-40 bg-gold/20 blur-3xl rounded-full pointer-events-none" />
              
// //               <h3 className="font-[family-name:var(--font-display)] text-2xl text-pearl mb-8">Register your interest</h3>
              
// //               <form className="flex flex-col gap-8 relative z-10" onSubmit={(e) => submitToFormspree(e, "enquire")}>
// //                 <input type="hidden" name="_subject" value="New enquiry — Confident Atria (Main Form)" />
...
// //                     suppressHydrationWarning
// //                     placeholder=" "
// //                     className="peer w-full bg-transparent border-b border-white/30 py-4 text-[16px] sm:text-[15px] text-pearl focus:outline-none focus:border-gold transition-colors"
// //                   />
// //                   <label htmlFor="name" className="absolute left-0 top-4 text-[15px] text-pearl/50 transition-all peer-focus:-top-3 peer-focus:text-[11px] peer-focus:text-gold peer-focus:tracking-widest peer-focus:uppercase peer-valid:-top-3 peer-valid:text-[11px] peer-valid:text-gold peer-valid:tracking-widest peer-valid:uppercase">
// //                     Full Name
// //                   </label>
// //                 </div>
...
// //                     className="peer w-full bg-transparent border-b border-white/30 py-4 text-[16px] sm:text-[15px] text-pearl focus:outline-none focus:border-gold transition-colors"
// //                   />
// //                   <label htmlFor="phone" className="absolute left-0 top-4 text-[15px] text-pearl/50 transition-all peer-focus:-top-3 peer-focus:text-[11px] peer-focus:text-gold peer-focus:tracking-widest peer-focus:uppercase peer-valid:-top-3 peer-valid:text-[11px] peer-valid:text-gold peer-valid:tracking-widest peer-valid:uppercase">
// //                     Phone Number
// //                   </label>
// //                 </div>
...
// //                     className="peer w-full bg-transparent border-b border-white/30 py-4 text-[16px] sm:text-[15px] text-pearl focus:outline-none focus:border-gold transition-colors"
// //                   />
// //                   <label htmlFor="email" className="absolute left-0 top-4 text-[15px] text-pearl/50 transition-all peer-focus:-top-3 peer-focus:text-[11px] peer-focus:text-gold peer-focus:tracking-widest peer-focus:uppercase peer-valid:-top-3 peer-valid:text-[11px] peer-valid:text-gold peer-valid:tracking-widest peer-valid:uppercase">
// //                     Email Address
// //                   </label>
// //                 </div>
...
// //                     suppressHydrationWarning
// //                     placeholder=" "
// //                     className="peer w-full bg-transparent border-b border-white/30 py-4 text-[16px] sm:text-[15px] text-pearl focus:outline-none focus:border-gold transition-colors resize-none"
// //                   />
// //                   <label htmlFor="message" className="absolute left-0 top-4 text-[15px] text-pearl/50 transition-all peer-focus:-top-3 peer-focus:text-[11px] peer-focus:text-gold peer-focus:tracking-widest peer-focus:uppercase peer-valid:-top-3 peer-valid:text-[11px] peer-valid:text-gold peer-valid:tracking-widest peer-valid:uppercase">
// //                     Message (Optional)
// //                   </label>
// //                 </div>
...
// //                   disabled={formStatus.enquire === "loading"}
// //                   suppressHydrationWarning
// //                   className="mt-6 w-full rounded-full bg-gold px-8 py-5 text-[14px] font-bold tracking-wider uppercase text-navy hover:bg-white hover:shadow-[0_0_25px_rgba(212,175,55,0.4)] hover:-translate-y-1 transition-all duration-300 disabled:opacity-60"
// //                 >
// //                   {formStatus.enquire === "loading" ? "Submitting..." : "Submit Enquiry"}
// //                 </button>

// //                 {formStatus.enquire === "success" && (
// //                   <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 bg-white/5 p-4 rounded-xl border border-gold/30">
// //                     <p className="flex items-center gap-2 text-[13px] text-green-400 font-medium">
// //                       <CheckCircle2 className="h-5 w-5" /> Thank you! We'll be in touch shortly.
// //                     </p>
// //                     <a
// //                       href={BROCHURE_URL}
// //                       target="_blank"
// //                       rel="noopener noreferrer"
// //                       className="inline-flex items-center justify-center gap-2 rounded-full bg-gold text-navy px-6 py-3 text-[12px] font-bold tracking-wider uppercase hover:bg-white transition-all duration-300"
// //                     >
// //                       <Download className="h-4 w-4" /> Download Brochure
// //                     </a>
// //                   </div>
...
// //       {/* ---------------------------------------------------------- FOOTER */}
// //       <footer className="px-6 lg:px-10 py-16 border-t border-navy/10 bg-[#FAFAFA]">
// //         <div className="mx-auto max-w-7xl flex flex-col md:flex-row md:items-center md:justify-between gap-10">
// //           <Logo scrolled={true} variant="footer" />
// //           <div className="flex flex-col sm:flex-row gap-6 sm:gap-10 text-[14px] text-navy/70">
// //             <span className="flex items-center gap-3 hover:text-gold transition-colors font-medium">
// //               <MapPin className="h-4 w-4 text-gold" /> {ADDRESS[1]}
// //             </span>
// //             <span className="flex items-center gap-3 hover:text-gold transition-colors font-medium">
// //               <Phone className="h-4 w-4 text-gold" /> {PHONES.join(" / ")}
// //             </span>
// //           </div>
// //           <p className="text-[13px] text-navy/80 tracking-wide text-right md:text-left">
// //             Constructed by SVT Developers | Marketed by <span className="text-gold font-bold uppercase">RRL Group</span> <br/>
// //             <span className="text-navy font-bold uppercase mt-2 block">© {new Date().getFullYear()} <span className="text-gold">Confident Atria</span></span>
// //             <span className="text-gold font-bold mt-1 block tracking-widest text-[11px] uppercase">Beyond Homes. A Lifestyle</span>
// //           </p>
// //         </div>
// //         <div className="mx-auto max-w-7xl mt-12 pt-8 border-t border-navy/10">
// //           <p className="text-[11px] leading-relaxed text-navy/50 italic">
// //             Disclaimer: These particulars are prepared as a general guide only. They do not form any part of a legally binding agreement. Visual representations, measurements, and specifications are approximate and subject to variation. All interested parties must conduct their own independent inquiries and inspections.
// //           </p>
// //         </div>
// //       </footer>
...
// //           {/* Modal Content */}
// //           <div className="relative w-full max-w-md rounded-[2.5rem] bg-navy border border-gold/30 p-8 sm:p-10 shadow-2xl animate-in fade-in zoom-in duration-300 max-h-[90vh] overflow-y-auto">
// //             <button 
// //               onClick={() => setIsPopupOpen(false)} 
// //               className="absolute top-6 right-6 text-pearl/50 hover:text-pearl transition-colors"
// //             >
...
// //             <div className="mb-8">
// //               <div className="h-14 w-14 rounded-full bg-gold/15 border border-gold/30 flex items-center justify-center mb-6">
// //                 <Lock className="h-6 w-6 text-gold" />
// //               </div>
// //               <h3 className="font-[family-name:var(--font-display)] text-2xl sm:text-3xl text-pearl mb-3 pr-8">Unlock Access</h3>
// //               <p className="text-[14px] text-pearl/70 font-light">Enter your details to instantly view the premium 4BHK layouts and download the full brochure.</p>
// //             </div>
            
// //             <form onSubmit={(e) => submitToFormspree(e, "unlock")} className="flex flex-col gap-6 relative z-10">
// //               <input type="hidden" name="_subject" value="New enquiry — Confident Atria (Unlock Popup)" />
// //               <div className="relative">
// //                 <input 
// //                   type="text" 
...
// //                   suppressHydrationWarning 
// //                   placeholder=" " 
// //                   className="peer w-full bg-transparent border-b border-white/30 py-3 text-[16px] sm:text-[15px] text-pearl focus:outline-none focus:border-gold transition-colors" 
// //                 />
// //                 <label className="absolute left-0 top-3 text-[14px] text-pearl/50 transition-all peer-focus:-top-3 peer-focus:text-[11px] peer-focus:text-gold peer-focus:tracking-widest peer-focus:uppercase peer-valid:-top-3 peer-valid:text-[11px] peer-valid:text-gold peer-valid:tracking-widest peer-valid:uppercase">
// //                   Full Name
// //                 </label>
// //               </div>
...
// //                 disabled={formStatus.unlock === "loading"}
// //                 suppressHydrationWarning
// //                 className="mt-6 w-full rounded-full bg-gold px-8 py-4 text-[14px] font-bold tracking-wider uppercase text-navy hover:bg-white transition-all duration-300 shadow-[0_4px_20px_rgba(212,175,55,0.4)] disabled:opacity-60"
// //               >
// //                 {formStatus.unlock === "loading" ? "Unlocking..." : "Unlock Now"}
// //               </button>
// //               {formStatus.unlock === "error" && (
...
// //     <a href="#" className="flex items-center gap-3 group">
// //       <span className="flex items-center gap-2.5 sm:gap-3">
// //         <span className="relative h-10 sm:h-12 w-[110px] sm:w-[130px]">
// //           <Image
// //             src={RRL_LOGO}
// //             alt="RRL Group logo"
// //             fill
...
// // }) {
// //   return (
// //     <div className="group border-t border-gold/20 pt-8 hover:border-gold transition-colors duration-500 relative bg-white px-6 pb-6 rounded-b-3xl shadow-[0_4px_20px_rgb(0,0,0,0.02)] hover:shadow-lg mt-2">
// //       <div className="absolute top-0 left-0 w-0 h-[2px] bg-gold transition-all duration-500 group-hover:w-full" />
// //       <Icon className="h-8 w-8 text-gold mb-5 group-hover:scale-110 transition-transform duration-500" strokeWidth={1.5} />
// //       <h3 className="text-[18px] font-bold text-navy mb-3">{title}</h3>
// //       <p className="text-[15px] leading-relaxed text-navy/70 font-medium">{body}</p>
// //     </div>
// //   );
// // }
...
//           className="flex items-center justify-center h-[56px] w-[56px] rounded-full bg-[#25D366] text-white shadow-xl hover:scale-110 transition-transform duration-300"
//         >
//           <MessageCircle className="h-7 w-7" />
//         </a>
//       </div>
...
const SPECS: { group: string; rows: [string, string][] }[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      ["Walls", "6\" Solid Block"],
      ["Main Door", "Teak Wood"],
      ["Main Door Lock", "Biometric Digital Lock"],
      ["Internal Doors", "Teak Wood Frame, Ready-made Flush Doors"],
      ["Windows", "3-Track UPVC, Wooden Pattern, Best Quality"],
    ],
  },
...
// Persist the "unlocked" state in the browser so a returning visitor who already
// submitted their details doesn't have to unlock floor plans / brochure again.
...
export default function Page() {
  ...
  useEffect(() => {
    ...
    // Restore unlock state for returning visitors who already submitted a form before.
    try {
      ...
      >
        <div className={`mx-auto max-w-7xl px-4 sm:px-6 lg:px-10 flex items-center justify-between transition-all duration-300 ${scrolled ? "h-16" : "h-20 sm:h-24"}`}>
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              href="#enquire"
              className="inline-flex items-center gap-2 rounded-full bg-gold px-6 py-2.5 text-[13px] font-semibold tracking-wide text-navy hover:bg-navy hover:text-pearl transition-all duration-300 shadow-[0_0_15px_rgba(212,175,55,0.25)]"
            >
              <Calendar className="h-3.5 w-3.5" /> Book a Site Visit
            </a>
            <a
              href={`tel:+91${PHONES[0]}`}
              className={`inline-flex items-center gap-2 rounded-full border px-6 py-2.5 text-[13px] font-medium tracking-wide transition-all duration-300 ${
            ...
            <div className="lg:col-span-7 grid sm:grid-cols-2 gap-10 lg:pl-10">
              ...
              <Reveal delay={500} className="sm:col-span-2">
                <div className="group border-t border-navy/10 pt-8 hover:border-gold transition-colors duration-500 relative">
                  ...
                  <Compass className="h-6 w-6 text-gold mb-5 group-hover:scale-110 transition-transform duration-500" strokeWidth={1.5} />
                  <h3 className="text-[18px] font-semibold text-navy mb-3">East-Facing, 1162 sqft</h3>
                  <p className="text-[15px] leading-relaxed text-navy/60 font-light">A 1162 sqft East-facing site carries 2400.50 sqft of built-up area across ground, first and terrace levels — RCC column framing, 6-inch solid block walls, teak wood doors with biometric digital locks and 3-track UPVC windows.</p>
                </div>
              </Reveal>
            </div>
          </div>
